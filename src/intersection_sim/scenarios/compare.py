"""CLI: 3 kontrolcuyu karsilastir, CSV ve PNG'leri yaz.
...
Adimlar:
    ...
    5. plots.compare.save_all_plots ile 4 PNG cikar
...
def parse_args(argv: "list[str] | None" = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        ...
        description="3 kontrolcuyu coklu seed ile kosturup karsilastirir.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help="Her kosumun suresi (saat; default: 4)",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help="Bonus histogram grafigini atla (daha hizli)",
    )
...
def main(argv: "list[str] | None" = None) -> None:
    ...
    print(f"Karsilastirma basliyor: {args.seeds} seed x 3 kontrolcu x "
    ...
    print("=" * 70)
    # Sade sutunlar — sunum icin onemli olanlar
    print(df[[
